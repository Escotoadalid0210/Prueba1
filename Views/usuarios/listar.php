                ...
                <div class="col-lg-12 mt-2">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            <button class="btn btn-dark" type="button" data-toggle="modal" data-target="#nuevo_user">Nuevo</button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table style=background-color:#000 class="table table-hover table-dark" id="table">
