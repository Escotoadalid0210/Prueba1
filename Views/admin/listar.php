        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <?php if ($_SESSION['rol'] == 1) { ?>
                    <button class="btn btn-dark" type="button" data-toggle="modal" data-target="#prestar"><i class="fas fa-plus-circle"></i></button>
                <?php } ?>
                </div>
                <div class="col-md-12">
                    <table style=background-color:#000 class="table table-dark" id="table">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url(); ?>admin/registrar">
                            ...
                            <button class="btn btn-secondary" type="submit">Prestar</button>
