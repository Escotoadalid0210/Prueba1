...
<div id="layoutSidenav_content">
    <main >
        <div class="container-fluid">
            <h5 class="text-center">Generos Libro</h5>
            <div class="row">
                <div class="col-lg-12">
                    <button class="btn btn-dark mb-2" type="button" data-toggle="modal" data-target="#nuevoMateria"><i class="fas fa-plus-circle"></i></button>
                    <div class="table-responsive">
                        <table style=background-color:#000 class="table table-dark mt-4" id="table">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white" id="my-modal-title">Registro Genero</h5>
