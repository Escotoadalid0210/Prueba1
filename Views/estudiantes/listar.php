...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <button class="btn btn-dark mb-2" type="button" data-toggle="modal" data-target="#nuevoEstudiante"><i class="fas fa-user-plus"></i></button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Atras</button>
                                </div>
                            </div>
                        </div>
                    </form>
